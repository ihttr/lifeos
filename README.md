...
التعلّم · الأهداف · المالية · التركيز · التقويم الموحّد · البحث الشامل · الإشعارات · الإحصائيات · الإعدادات · PWA
...
npm run test:e2e  # ٢٦ اختبار متصفح — مصادقة، صلاحيات، مهام، مشاريع، ملاحظات، جامعة
```
...
الترتيب المقترح لما تبقّى: **الأهداف** ← **التركيز** ← **المالية** ← **التقويم والبحث الشامل** ← **التعلّم** ← **الإحصائيات** ← **PWA**.
