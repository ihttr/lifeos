...
التعلّم · المالية · التقويم الموحّد · البحث الشامل · الإشعارات · الإحصائيات · الإعدادات · PWA
...
npm run test:e2e  # ٣٥ اختبار متصفح — مصادقة، صلاحيات، مهام، مشاريع، ملاحظات، جامعة، أهداف، تركيز
```
...
الترتيب المقترح لما تبقّى: **المالية** ← **التقويم والبحث الشامل** ← **التعلّم** ← **الإحصائيات** ← **PWA**.
