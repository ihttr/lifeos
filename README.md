...
| **لوحة التحكم** | **إحدى عشرة بطاقة قابلة للإظهار وإعادة الترتيب**: الأرقام، مهام اليوم، القادم، المشاريع، الأهداف، الجامعة، التعلّم، التركيز، المالية، الملاحظات، إجراءات سريعة |
...
| **الإعدادات** | الاسم، اللغة، المظهر، **تخصيص لوحة التحكم**، تصدير كل البيانات JSON، وحذف البيانات التجريبية |
...
npm run test:e2e  # ٦٩ اختبار متصفح — يغطّي كل قسم، مع فحص شامل لكل صفحة
```
...
7. **بطاقات لوحة التحكم مسجَّلة في مكان واحد** — `src/components/dashboard/widgets.ts` هو مصدر الحقيقة: الإعدادات تبني منه القائمة، واللوحة ترسم منه، والخادم يقرأ منه ليعرف أي استعلام يلزم. البطاقة المخفية لا تكلّف استعلاماً.
8. **ألوان المخططات مُتحقَّق منها لا مختارة بالذوق** — تمر بفحص نطاق الإضاءة وحد التشبّع والفصل لعمى الألوان والتباين ≥ 3:1، في الوضعين. نطاق الوضع الداكن أضيق (L 0.48–0.67) فألوانه خطوة أخرى غير الفاتح لا انعكاساً له.
