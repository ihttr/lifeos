...
| **لوحة التحكم** | **عشر بطاقات قابلة للإظهار وإعادة الترتيب**: الأرقام، مهام اليوم، القادم، المشاريع، الأهداف، الجامعة، التركيز، المالية، الملاحظات، إجراءات سريعة |
...
npm run test:e2e  # ٦٨ اختبار متصفح — يغطّي كل قسم، مع فحص شامل لكل صفحة
```
