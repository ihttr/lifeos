...
| **التركيز** | مؤقت بومودورو مثبَّت على الزمن الحقيقي ينجو من إعادة التحميل، مدد قابلة للتخصيص، ربط الجلسة بمهمة، إحصائيات وسلسلة أيام، ومخطط ٢٨ يوماً |
| **المالية** | دخل ومصروف بالريال، تصفّح شهري، مجاميع ورصيد، مخطط ستة أشهر، وتوزيع المصروف على التصنيفات |
| **البنية** | i18n، ثيم، شريط جانبي وتنقّل سفلي للجوال، لوحة أوامر ⌘K، حالات فارغة وأخطاء، تأكيد قبل الحذف |

### لم يُبنَ بعد

التعلّم · التقويم الموحّد · البحث الشامل · الإشعارات · الإحصائيات · الإعدادات · PWA
...
npm run test:e2e  # ٤٠ اختبار متصفح — يغطّي كل قسم مبني
```
...
الترتيب المقترح لما تبقّى: **التقويم والبحث الشامل** ← **التعلّم** ← **الإحصائيات** ← **PWA**.
